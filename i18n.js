...
(() => {
  ...
  const translations = {
    bg: {
      ...
      promo: {
        title: "Специални промоции и меню",
        subtitle:
          "Промоции при поръчки за вкъщи и преференции за нашите гости.",
        card1Title: "СПЕЦИАЛНА ПРОМОЦИЯ",
        card1Text:
          "➡️ <strong>10% отстъпка на всички поръчки за вкъщи до Нова година</strong> (за всички жени, които не обичат да готвят…).",
        card2Title: "ЗА НАШИТЕ КЛИЕНТИ",
        card2Text1:
          "За всички гости на хотела <strong>-20% отстъпка в ресторанта</strong>.",
        card2Text2:
          "Подробна информация и актуални оферти ще получите при контакт с нас.",
        menuCta: "Виж менюто",
      },
      teaser: {
    ...
    en: {
      ...
      promo: {
        title: "Special offers & menu",
        subtitle: "Takeaway discounts and special perks for our guests.",
        card1Title: "SPECIAL OFFER",
        card1Text:
          "➡️ <strong>10% off all takeaway orders until New Year</strong> (for everyone who doesn’t feel like cooking…).",
        card2Title: "FOR OUR CLIENTS",
        card2Text1:
          "All hotel guests get <strong>-20% discount in the restaurant</strong>.",
        card2Text2: "Contact us for details and current offers.",
